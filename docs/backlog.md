...
- ~~**Step 3**: drop `psa_attorney_name` and `psa_attorney_firm`.~~ **Done 2026-08-27**, migration `0036`. Nothing read them after step 2, and `0034` had already backfilled all three deals' values onto the roster. `deals.psa_drafting` stays. This entry is now closed.
